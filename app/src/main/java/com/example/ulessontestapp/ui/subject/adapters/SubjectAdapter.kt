...
import com.example.ulessontestapp.ui.subject.SubjectViewModel
import kotlinx.android.synthetic.main.subject_item.view.*

class SubjectAdapter(private val viewModel: SubjectViewModel):
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(viewModel: SubjectViewModel, subject: Subject) {
